 ...
 */
public class ReviewJobMainboardAdapter extends RecyclerView.Adapter<ReviewJobMainboardAdapter.VersionViewHolder> {
    ...
    public ReviewJobMainboardAdapter(List<ReviewJob> login, int rowLayout, Context context, OnItemClickListener listener) {
