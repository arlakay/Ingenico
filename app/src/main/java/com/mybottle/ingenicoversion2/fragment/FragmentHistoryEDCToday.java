...
public class FragmentHistoryEDCToday extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    @BindView(R.id.recycler_review_edc_today)RecyclerView recyclerViewReviewToday;
    @BindView(R.id.swipe_refresh_layout)SwipeRefreshLayout swipeRefreshLayout;
    @BindView(R.id.txt_list_kosong)TextView textListKosong;

    private static String TAG = FragmentHistoryEDCToday.class.getSimpleName();
    ...
    public static FragmentHistoryEDCToday newInstance() {
        return new FragmentHistoryEDCToday();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView =  inflater.inflate(R.layout.fragment_history_edc_today, container, false);
    ...
    private void getHistoryTechnician() {
        ...
        Call<ReviewJobResponse> call = apiService.getHistoryEDCToday(techCode, BuildConfig.INGENICO_API_KEY);
        call.enqueue(new Callback<ReviewJobResponse>() {
            ...
            public void onResponse(Call<ReviewJobResponse>call, Response<ReviewJobResponse> response) {
                ...
                if (response.isSuccessful() && response.body().isStatus()) {
                    ...
                    Log.d(TAG, "EDC_TODAY: " + new Gson().toJson(reviewJobList));

                    Bundle params = new Bundle();
                    params.putString("name", techCode);
                    mFirebaseAnalytics.logEvent("history_EDC_today", params);

                    adapter = new ReviewJobEDCAdapter(reviewJobList, R.layout.list_item_review_job, getActivity(), new ReviewJobEDCAdapter.OnItemClickListener() {
                        @Override
